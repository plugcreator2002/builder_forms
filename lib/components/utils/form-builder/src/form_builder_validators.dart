...
import 'package:forms_builder/components/utils/form-builder/localization/form_builder_localizations.dart';
import 'package:forms_builder/components/utils/form-builder/src/utils/validators.dart';
import 'package:forms_builder/components/utils/operation_checker.dart';
import 'package:forms_builder/components/utils/operation_converter.dart';
...
class FormValidators {
  ...
  static FormFieldValidator<String> integer(
    ...
    return (candidate) {
      final number = isInteger(candidate);
      if (isTrue(candidate?.isNotEmpty) && number == null) {
